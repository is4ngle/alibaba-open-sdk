...
final class Registry
{
    ...
    'BuyerOutproductRelationAdd' => ['class' => \Is4ngle\AlibabaOpen\Api\Fenxiao\BuyerOutproductRelationAddRequest::class, 'api' => 'com.alibaba.fenxiao:alibaba.fenxiao.buyer.outproduct.relation.add-1'],
    'BuyerOutproductRelationDelete' => ['class' => \Is4ngle\AlibabaOpen\Api\Fenxiao\BuyerOutproductRelationDeleteRequest::class, 'api' => 'com.alibaba.fenxiao:alibaba.fenxiao.buyer.outproduct.relation.delete-1'],
    'BuyerOutproductRelationGet' => ['class' => \Is4ngle\AlibabaOpen\Api\Fenxiao\BuyerOutproductRelationGetRequest::class, 'api' => 'com.alibaba.fenxiao:alibaba.fenxiao.buyer.outproduct.relation.get-1'],
    'BuyerOutshopAdd' => ['class' => \Is4ngle\AlibabaOpen\Api\Fenxiao\BuyerOutshopAddRequest::class, 'api' => 'com.alibaba.fenxiao:alibaba.fenxiao.buyer.outshop.add-1'],
    'BuyerOutshopDelete' => ['class' => \Is4ngle\AlibabaOpen\Api\Fenxiao\BuyerOutshopDeleteRequest::class, 'api' => 'com.alibaba.fenxiao:alibaba.fenxiao.buyer.outshop.delete-1'],
    ...
    'ProductInfoGet' => ['class' => \Is4ngle\AlibabaOpen\Api\Fenxiao\ProductInfoGetRequest::class, 'api' => 'com.alibaba.fenxiao:alibaba.fenxiao.productInfo.get-1'],
    ...
    'MyFreightTemplateListGet' => ['class' => \Is4ngle\AlibabaOpen\Api\Logistics\MyFreightTemplateListGetRequest::class, 'api' => 'com.alibaba.logistics:alibaba.logistics.myFreightTemplate.listGet-1'],
    ...
    'AlibabaPublicImageSimilarOfferSearch' => ['class' => \Is4ngle\AlibabaOpen\Api\Product\AlibabaPublicImageSimilarOfferSearchRequest::class, 'api' => 'com.alibaba.product:alibaba.public.imageSimilarOfferSearch-1'],
    'ProductKeywordSearch' => ['class' => \Is4ngle\AlibabaOpen\Api\Product\ProductKeywordSearchRequest::class, 'api' => 'com.alibaba.product:product.keyword.search-1'],
    ...
    'AlibabaOrderMemoAdd' => ['class' => \Is4ngle\AlibabaOpen\Api\Trade\AlibabaOrderMemoAddRequest::class, 'api' => 'com.alibaba.trade:alibaba.order.memoAdd-1'],
    ...
    'GrouppayUrlGet' => ['class' => \Is4ngle\AlibabaOpen\Api\Trade\GrouppayUrlGetRequest::class, 'api' => 'com.alibaba.trade:alibaba.trade.grouppay.url.get-1'],
    'PayProtocolPayIsopen' => ['class' => \Is4ngle\AlibabaOpen\Api\Trade\PayProtocolPayIsopenRequest::class, 'api' => 'com.alibaba.trade:alibaba.trade.pay.protocolPay.isopen-1'],
    'PayProtocolPayPreparePay' => ['class' => \Is4ngle\AlibabaOpen\Api\Trade\PayProtocolPayPreparePayRequest::class, 'api' => 'com.alibaba.trade:alibaba.trade.pay.protocolPay.preparePay-1'],
    ...
    'RefundBuyerQueryOrderRefundList' => ['class' => \Is4ngle\AlibabaOpen\Api\Trade\RefundBuyerQueryOrderRefundListRequest::class, 'api' => 'com.alibaba.trade:alibaba.trade.refund.buyerQueryOrderRefundList-1'],
    'RefundOpQueryBatchRefundByOrderIdAndStatus' => ['class' => \Is4ngle\AlibabaOpen\Api\Trade\RefundOpQueryBatchRefundByOrderIdAndStatusRequest::class, 'api' => 'com.alibaba.trade:alibaba.trade.refund.OpQueryBatchRefundByOrderIdAndStatus-1'],
    'RefundOpQueryOrderRefundOperationList' => ['class' => \Is4ngle\AlibabaOpen\Api\Trade\RefundOpQueryOrderRefundOperationListRequest::class, 'api' => 'com.alibaba.trade:alibaba.trade.refund.OpQueryOrderRefundOperationList-1'],
    'RefundOpQueryOrderRefund' => ['class' => \Is4ngle\AlibabaOpen\Api\Trade\RefundOpQueryOrderRefundRequest::class, 'api' => 'com.alibaba.trade:alibaba.trade.refund.OpQueryOrderRefund-1'],
    'RefundReturnGoods' => ['class' => \Is4ngle\AlibabaOpen\Api\Trade\RefundReturnGoodsRequest::class, 'api' => 'com.alibaba.trade:alibaba.trade.refund.returnGoods-1'],
    ...
    'TradeReceivegoodsConfirm' => ['class' => \Is4ngle\AlibabaOpen\Api\Trade\TradeReceivegoodsConfirmRequest::class, 'api' => 'com.alibaba.trade:trade.receivegoods.confirm-1'],
